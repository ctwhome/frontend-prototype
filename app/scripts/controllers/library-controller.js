 ...
 */
App.controller('library-controller', function ($scope) {
    $scope.materials = [
            ...
            {"id":7,"name":"Acetaminophen and Diphenhydramine Hydrochloride","desc":"Factitious dis w symptom","color":"#2584c1","type":"Goldenrod"},
            ...
            {"id":18,"name":"Eucalyptol, menthol, methyl salicylate, thymol","desc":"Acc poison-heroin","color":"#f24c7e","type":"Fuscia"},
            {"id":19,"name":"haloperidol","desc":"Polyhydramnios-unspec","color":"#b20589","type":"Pink"},
            {"id":20,"name":"Sodium Chloride","desc":"Bartonellosis","color":"#d075ff","type":"Maroon"},
